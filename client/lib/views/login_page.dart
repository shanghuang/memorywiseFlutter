...
import 'package:client/services/resp_service.dart';
                    ...
                    ElevatedButton.icon(
                        onPressed: () async {
                          if (userController.text.isEmpty ||
                            ...
                            UserResponse resp = await login(userController.text, passwordController.text);

                            final locator = GetIt.instance;
                            final _graphqlService = locator<GraphqlService>();
                            final ValueNotifier<GraphQLClient> gqlClient = _graphqlService.graphql_connect(resp.token);
